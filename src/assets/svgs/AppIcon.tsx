...
export const AppIcon = (props: SvgProps) => (
  <Svg width={128} height={128} fill="none" {...props}>
    ...
    <Path
      ...
      strokeLinecap="round"
      strokeWidth={8}
      d="M114.667 42.667H13.333M56 13.333 37.333 42.667M90.667 13.333 72 42.667M80 77.333c0-3.378-3.53-5.656-10.592-10.212-7.158-4.618-10.737-6.927-13.406-5.232-2.669 1.696-2.669 6.279-2.669 15.444 0 9.166 0 13.75 2.67 15.445 2.668 1.695 6.247-.614 13.405-5.232C76.469 82.989 80 80.71 80 77.333Z"
    />
  </Svg>
);
